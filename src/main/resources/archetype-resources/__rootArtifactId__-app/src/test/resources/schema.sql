...
#end
CREATE TABLE properties_bean_definition (id BIGINT NOT NULL AUTO_INCREMENT, bean_name VARCHAR(64) NOT NULL, property_name VARCHAR(255) NOT NULL, property_value VARCHAR(2000), PRIMARY KEY (id));